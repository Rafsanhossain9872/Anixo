...
export default function EstimatedSchedule() {
 ...
 className={`flex items-center gap-1.5 px-3 py-1.5 md:py-1.5 rounded-[3px] text-[10px] md:text-[11px] font-bold transition-all ${viewMode === 'list' ? 'bg-[#ff4d2e] text-white ' : 'text-[#888] hover:text-white'}`}
 >
 <ListIcon size={14} /> <span className="hidden xs:inline">LIST</span>
 </button>
 <button
 onClick={() => setViewMode("grid")}
 className={`flex items-center gap-1.5 px-3 py-1.5 md:py-1.5 rounded-[3px] text-[10px] md:text-[11px] font-bold transition-all ${viewMode === 'grid' ? 'bg-[#ff4d2e] text-white ' : 'text-[#888] hover:text-white'}`}
 >
 ...
 className={`px-2.5 py-1 text-[10px] font-bold rounded-[3px] transition-all ${filters.format === f ? 'bg-[#ff4d2e] text-white ' : 'bg-white/5 text-[#888] hover:text-white hover:bg-white/10'}`}
 >
 {f}
 </button>
 ))}
 ...
 className={`px-2.5 py-1 text-[10px] font-bold rounded-[3px] transition-all ${filters.status === s ? 'bg-[#ff4d2e] text-white ' : 'bg-white/5 text-[#888] hover:text-white hover:bg-white/10'}`}
 >
 {s}
 </button>
 ))}
 ...
 ? "bg-[#ff4d2e] border border-[#ff4d2e]"
