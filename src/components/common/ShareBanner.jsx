    ...
    <div className="w-full max-w-[1500px] mx-auto px-4 md:px-8 mb-10 mt-6">
      <div className="relative overflow-hidden bg-gradient-to-r from-[#1a1217] via-[#21141e] to-[#271725] border border-white/15 rounded-2xl p-4 md:p-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-5 transition-all duration-300 shadow-2xl">
        ...
        <div className="flex items-center gap-4 md:-ml-4">
          <div className="w-[80px] shrink-0 rounded-lg overflow-hidden flex items-center justify-center">
            <img
              src="https://media1.tenor.com/m/7iJXvW8LFF8AAAAd/please-appeal.gif"
              alt="Please share"
              draggable={false}
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          <div className="hidden lg:block text-right mr-4">
            <div className="text-white/20 font-medium text-[14px] leading-none tracking-tight">
              <span className="text-white/40 font-medium">330k</span> {t('share.shares')}
            </div>
          </div>
